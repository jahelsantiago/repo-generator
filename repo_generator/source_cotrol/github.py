#verify a given user exists on github

#verify a given repo exists on github for a given user

#create a temporary directory in the current directory

#delete the temporary directory in the current directory

#clone a given repo into a given directory
